...
output:
  ...
  bookdown::html_document2: 
    toc: false
bibliography: library.bib #I am having trouble with the bib file (error message: pandoc error 83 file not found). Removing this line for now so that Manuscript will knit. Will continue to troubleshoot and fix bib formatting. Bib file works now, but some citations recieve double brackets. Will continue looking into this issue
csl: elsevier.csl
---
