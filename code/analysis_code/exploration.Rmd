...
wrf <- mpdata %>% select("ccwrf", "nowrf", "miwrf") 
...
#minwrf contains the variable min, which tells us the distance from the sample site to the nearest WRF. This is all of the information that we need, so no we will re-join to the original DF
