...
# linear regression
```{r}
data <- data %>% select("particles_l", "visual_score", "turbidity.ntu", "temperature.c", "e.coli.cfu", "population", "dist")
...
Here, I am still confused about why so many rmse values are resulting. Earlier, I was getting multiple rmse values but thought it was because I was building a model with all predictors. Here, I am using one predictor but still getting multiple rmse values. If I remember correctly, there was only one rmse value in the exercises we worked on in the previous weeks. 