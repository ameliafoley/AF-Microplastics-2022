...
ggplot(data, aes(x = population, y = particles_l)) + geom_point() + geom_smooth(method = lm) + labs(title = "Microplastic Concentration vs. Population", x = "Population", y = "Particles/Liter")
```
...
#attempt to visualize data
#look at particles per L vs population
data %>% filter(particles_l < 750) %>% ggplot(aes(x = population, y = particles_l)) + geom_point() + geom_smooth(method = lm) + labs(title = "Microplastic Concentration vs. Population", x = "Population", y = "Particles/Liter")
```
...
#attempt to visualize data
#look at particles per L vs population
ggplot(data, aes(x = population, y = particles_l)) + geom_point() +
...
```{r}
ggplot(data, aes(x = e.coli.cfu, y = particles_l)) + geom_point() + geom_smooth(method = lm) + labs(title = "Microplastic Concentration vs. E. coli CFU", x = "CFU/mL", y = "Particles/Liter")
```

# particles per liter vs e.coli.cfu with log transformation
```{r}
ggplot(data, aes(x = e.coli.cfu, y = particles_l)) + geom_point() + scale_x_continuous(trans='log10') +
